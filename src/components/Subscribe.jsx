...
const Subscribe = () => {
  return (
    <div>
      ...
      <div className="h-[23.5rem] w-[84%] mx-auto rounded-2xl  bg-gradient-to-br from-[#242A44] via-[#242A44] to-[#17192E] mb-[5rem] mt-[4rem]">
        <div className="text-center">
          <h3 className="text-[1.4rem] font-semibold pb-[0.7rem] pt-[3.5rem]">Let's Subscribe</h3>
